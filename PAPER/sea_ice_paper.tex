...
Young Ice (\texttt{\texttimes}), confirming the classification failure discussed
in Section~\ref{sec:oi_failure}.

\begin{figure*}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/sample_predictions.png}
  \caption{Qualitative segmentation results — one sample per ice class.
           ...
           (\checkmark\ correct, \texttimes\ incorrect).
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/segmentation_overview.png}
