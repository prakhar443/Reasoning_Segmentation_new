...
\Title{Reasoning-Aware Sea-Ice Understanding: Joint Segmentation and
Six-Class Ice-Type Classification from Synthetic Aperture Radar Imagery}
...
\keyword{SAR sea ice segmentation; reasoning-aware segmentation; CLIP; LoRA;
...
PixelLM \cite{ren2024pixellm} have demonstrated the value of reasoning-informed
...
\begin{enumerate}[leftmargin=*,label=\arabic*.]
  ...
  \item We introduce a \textbf{reasoning-informed multimodal fusion strategy}
        ...
        descriptions through cross-attention.
...
While these systems demonstrate the value of reasoning-informed multimodal understanding
...
five sequential modules: (1) SAR preprocessing, (2) reasoning-aware visual
...
\subsection{Reasoning-Aware Visual Encoder}
\label{sec:encoder}
...
\subsection{Comparison with Reasoning-Segmentation Baselines}
...
\centering
\small
\caption{Comparison against reasoning-segmentation baselines on the
