...
\caption{Comparison against language-guided segmentation baselines on the
         90-image SAR sea ice test split. All methods share the same evaluation
         harness and Otsu-binarised ground truth.
...
Our model leads on all three metrics. The gap over LISA-7B is
