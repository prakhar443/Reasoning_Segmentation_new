...
A separate study compares this model against published zero-shot and
reasoning-segmentation baselines (CLIPSeg, LISA-7B, GeoPixel-7B,
...
0.1226 / 0.1268; GeoPixel-7B 0.0316 / 0.0350 / 0.0597. PixelLM-7B is
